	 ...
	 ?>
      <div id="page-wrapper" style="background-image:url(bg.jpg)">
          <div class="row" >
            ...
            <!-- /.row -->
            <div class="row">
            <div class="col-lg-6" style=" background-image:url(tbg.png)"></br>
             <form action="ptrip.php"  method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" min="0" name="days" placeholder="Enter the date from which trip starts...">
                                        </div>
                                        <div class="form-group">
                                            <label>Hotel we gotta stay at...</label>
                                            <input class="form-control" type="text" name="hotel" placeholder="Enter the hotel name we gotta stay at...">
                                        </div>
                                        <div class="form-group">
