...
if(isset($_POST["submit"]))
{
	...
	$res=mysql_query("select * from user where email='$id' and pwd='$pwd'") or die('query error');
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">RajuGuide - Sign In</h3>
                    </div>
                    <div class="panel-body">
                   <center> <img src="logo.jpg" width="200" height="190"></center>
